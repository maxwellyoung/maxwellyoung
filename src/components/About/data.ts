...
export const otherventures: Content[] = [
  ...
  {
    title: "DJ",
    content: "I help people have fun by DJing parties with my friend Thom.",
  },
  {
    title: "Composer",
    content: "Currently composing a video game soundtrack.",
  },
  {
    title: "Radio DJ",
    content:
...
export const visual: Content[] = [
  ...
  {
    title: "Church - Orange",
    content: "Single Artwork for Church",
    href: "https://open.spotify.com/album/6Fg8W91ZK9HeBZSsLWXTje?si=sD15A_Q8TfaB6tFRYP4iqg",
  },
];
