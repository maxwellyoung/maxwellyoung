      ...
      <div className={styles.home_container}>
        <div className={styles.info}>
          <div className={styles.headshot}>
            <Image src="/photos/profile.jpg" alt="Maxwell Young" fill={true} />
          </div>
          <h1>Maxwell Young — Developer, Designer & Musician</h1>
          ...
          <p>Hey there! I'm Maxwell Young.</p>
          <br />
          <p>
          ...
          <br />
          <p>
            I'm passionate about making software simple with intention and
          ...
          <p>
            If you're ever in Auckland, New Zealand, let's hang out. Looking for
            new opportunities. Reach out at{" "}
            <a
